const TIMELINE_SUMMARY = [
  { dday: "D-12개월", tag: "상견례", items: [
    {cat:"예식 준비", text:"양가 상견례 일정 조율"},
    {cat:"예식 준비", text:"예식 시기·예산 범위 정하기"},
